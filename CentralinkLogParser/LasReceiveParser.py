...
TABLE_UPDATE_TIMESTAMP_ID = r'Las_Receive'
...
class LasReceiveParser():
    ...
    def parse(self,log_file_list):
        ...
        if not log_file_list:
            print 'null log file list of Las Receive'
            return
...
def test():
    ...
    las_receive_log_file_list = las_receive_parser.pre_work(las_receive_log_folder)
    las_receive_parser.work(las_receive_log_file_list)
